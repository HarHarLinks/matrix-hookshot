...
import { BridgeConfigGitHub, BridgeConfigGitLab, GitLabInstance } from "../Config/Config";
import { GetIssueResponse } from "../Gitlab/Types";
import { IGitLabWebhookNoteEvent } from "../Gitlab/WebhookTypes";
import { getIntentForGitHubUser, getIntentForGitLabUser } from "../IntentUtils";
...
export class GitLabIssueConnection extends BaseConnection implements IConnection {
    ...
    public async onCommentCreated(event: IGitLabWebhookNoteEvent) {
        ...
        const commentIntent = await getIntentForGitLabUser(event.user, this.as, this.config.userIdPrefix || "_gitlab_");
